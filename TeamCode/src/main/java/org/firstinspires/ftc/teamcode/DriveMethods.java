...
//                    GoToHeight(targetHeight - 60);
    ...
    public void alignToConeStack(OpenCvCamera camera, double heading, String coneColor) {
        String level = "one";
        int levelCounter = 1;
        double errorX;
        int errorWidth;
...
//            }
            ...
            PipeConeTracker pipeConeTracker = new PipeConeTracker(level, coneColor);
