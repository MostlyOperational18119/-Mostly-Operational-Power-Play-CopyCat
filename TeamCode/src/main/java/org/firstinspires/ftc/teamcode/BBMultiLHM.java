...
@Autonomous(name ="BBMultiLHM", group = "A")
public class BBMultiLHM extends DriveMethods{
    OpenCvWebcam webcam;
    ...
    public void runOpMode() {
        ...
        sleep(300);
        GoToHeight(1600);
        driveForDistanceBrake(1.73, Variables.Direction.BACKWARD, .7, globalTargetRotation);
...
//        sleep(100);
        goToHigh();
        sleep(200);
        driveForDistanceBrake(.24, Variables.Direction.FORWARD, .3, globalTargetRotation);
        sleep(300);
